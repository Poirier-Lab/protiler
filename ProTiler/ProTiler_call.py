...
'''
def Visualization(gene,outputdir,exons_dic,sift_genome_dic,domain_genome_dic,ss_genome_dic,po_dic,ac_dic,me_dic,ub_dic,title):
    ...
    plt.subplot(gs[0])
    plt.title('CKHS profile and annotations for '+ gene + ' '+title,fontsize=14)
